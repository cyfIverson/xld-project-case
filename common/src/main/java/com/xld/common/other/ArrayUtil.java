...
public class ArrayUtil {
    ...
    public static Object[] cast(Class<?> type, Object arrayObj) throws NullPointerException, IllegalArgumentException {
        ...
        final Object[] result = cn.hutool.core.util.ArrayUtil.newArray(componentType, array.length);
    ...
    public static String toString(Object obj) {
        ...
        if (cn.hutool.core.util.ArrayUtil.isArray(obj)) {
            try {
    ...
    public static <T> String join(T[] array, CharSequence conjunction, String prefix, String suffix) {
        ...
        for (T item : array) {
            ...
            if (cn.hutool.core.util.ArrayUtil.isArray(item)) {
                sb.append(join(cn.hutool.core.util.ArrayUtil.wrap(item), conjunction, prefix, suffix));
